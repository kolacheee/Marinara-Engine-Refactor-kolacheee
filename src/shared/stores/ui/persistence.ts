...
export function partializeUiState(state: UIState) {
  return {
    ...
    remoteRuntimeAuthMode: state.remoteRuntimeAuthMode,
    remoteRuntimeUsername: state.remoteRuntimeUsername,
    remoteRuntimePassword: state.remoteRuntimePassword,
    remoteRuntimeApiKey: state.remoteRuntimeApiKey,
